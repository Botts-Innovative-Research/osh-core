...
import org.vast.swe.fast.AbstractDataWriter;
...
public class ObsBindingCotXml extends ResourceBindingJson<BigId, IObsData>
{
    ...
    public ObsBindingCotXml(RequestContext ctx, IdEncoders idEncoders, boolean forReading, IObsStore obsStore) throws IOException
    {
