 ...
 */
public class CoTHelper extends VectorHelper
{

    private static final Logger logger = LoggerFactory.getLogger(CoTHelper.class);
    ...
    public Time createPrecisionTimeStamp(){
        return createTime()
                ...
                .name("time")
                .description("time stamp: when the event was generated")
                .build();
    }

    public Quantity createCoTVersion(){
        return createQuantity()
                .name("version")
                .label("Version")
                .definition(SWEHelper.getPropertyUri("cot-version"))
                .description("Schema version of this event instance (e.g. 2.0)")
                .build();
    }
    public Category createUID(){
    ...
    public Category createType(){
        return createCategory()
                .name("type")
                .label("Type")
                .definition(SWEHelper.getPropertyUri("cot-type"))
                .description("Hierarchically organized hint about event type")
                .build();
    }

    public Time createStartTime(){
        return createTime()
                .asSamplingTimeIsoUTC()
                .name("start-time")
                .label("Start Time")
                .definition(SWEHelper.getPropertyUri("start-time"))
                .description("starting time when an event should be considered valid")
                .build();
    }

    public Time createStaleTime(){
        return createTime()
                .asSamplingTimeIsoUTC()
                .name("stale-time")
                .label("Stale Time")
                .definition(SWEHelper.getPropertyUri("stale-time"))
                .description("ending time when an event should no longer be considered valid")
                .build();
    }
    public Text createHow(){
        return createText()
                .name("how")
                .label("How")
                .definition(SWEHelper.getPropertyUri("cot-how"))
                .description("Gives a hint about how the coordinates were generated")
                .build();
    }

    public Quantity createCE(){
        return createQuantity()
                .name("ce")
                .label("Radius")
                .definition(SWEHelper.getPropertyUri("cot-ce"))
                .description("Circular 1-sigma or a circular area about the point in meters")
                .uomCode("m")
                .build();
    }
    public Quantity createLE(){
        return createQuantity()
                .name("le")
                .label("Height")
                .definition(SWEHelper.getPropertyUri("cot-le"))
                .description("Linear 1-sigma error or an altitude range about the point in meters")
                .uomCode("m")
                .build();
    }

    public Text createRmkSrc(){
        return createText()
                .name("source")
                .label("Source")
                .definition(SWEHelper.getPropertyUri("Remarks Source"))
                .description("OpenSensorHub")
                .build();
    }
